...
/datum/skills/systems_alliance_medic
	name = "Medic"
...
/datum/skills/systems_alliance_n7
	name = "N7 Soldier" //Best skills of a human

	cqc = 3
	firearms = SKILL_FIREARMS_TRAINED
	leadership = SKILL_LEAD_TRAINED
	medical = SKILL_MEDICAL_NOVICE //Should be able to use at least basic medical programs on omni-tool
	surgery = SKILL_SURGERY_AMATEUR
	melee_weapons = SKILL_MELEE_TRAINED
	pistols = SKILL_PISTOLS_TRAINED
	smgs = SKILL_SMGS_TRAINED
